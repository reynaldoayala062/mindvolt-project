...
const Footer = () => {
    return (
        <div id='footer-container'>
            <div id='footer-logos'>
                <img src="https://mindvolt-project.s3.us-east-2.amazonaws.com/firstbank-logo-2016.png" alt='' width='12%'/>
                <img src='https://mindvolt-project.s3.us-east-2.amazonaws.com/Visa-Logo.png' alt='' width='8%'/>
            </div>
            <div id='footer-text'>
